...
for i,j in zip(lista_items, nombre_items):
    ...
    df_item=df_item[(df_item['2019'].notnull())|(df_item['2020'].notnull())]
    
    diccionario_proveedores_procesos['item'].append(j)
    
    diccionario_proveedores_procesos['num_prov_hist'].append(df_item['contracts/0/signatories/0/name'][df_item['pre_emergencia']==1].nunique())
    
    diccionario_proveedores_procesos['num_procesos_hist'].append(df_item['ocid'][df_item['pre_emergencia']==1].nunique())
    
    diccionario_proveedores_procesos['num_prov_emer'].append(df_item['contracts/0/signatories/0/name'][df_item['pos_emergencia']==1].nunique())
    
    diccionario_proveedores_procesos['num_procesos_emer'].append(df_item['ocid'][df_item['pos_emergencia']==1].nunique()) 
    
    try:
        diccionario_proveedores_procesos['%prov_proc_hist'].append(df_item['contracts/0/signatories/0/name'][df_item['pre_emergencia']==1].nunique()/df_item['ocid'][df_item['pre_emergencia']==1].nunique())
    
    except:
        diccionario_proveedores_procesos['%prov_proc_hist'].append(np.nan)
        
    try:
        diccionario_proveedores_procesos['%prov_proc_emer'].append(df_item[df_item['pos_emergencia']==1]['contracts/0/signatories/0/name'].nunique()/df_item['ocid'][df_item['pos_emergencia']==1].nunique())                                                           
   
    except: 
        diccionario_proveedores_procesos['%prov_proc_emer'].append(np.nan)

        
proveedores_procesos1920=pd.DataFrame.from_dict(diccionario_proveedores_procesos)

# Save csv
output_path=''

proveedores_procesos1920.to_excel(output_path, index=False, sep=',', encoding='utf-8')
